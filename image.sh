#!/bin/bash
wine grit images/background.png -gzl -gB 4 -mRtfp -mLs -mzl -ftc -o images/background.h
wine grit images/lucas.png -gzl -gB 4 -gT 0xaddddd -ftc -o images/lucas.h
wine grit images/dawnshrink.png -gzl -gB 4 -gT 0xaddddd -ftc -o images/dawnshrink.h
